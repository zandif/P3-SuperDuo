...
public class myFetchService extends IntentService
{
    ...
    {
        Log.d(LOG_TAG, "reached onHandleIntent");
        getData("n2");
        getData("p2");
    ...
    private void getData (String timeFrame)
    {
        ...
        try {
            ...
            if (inputStream == null) {
                // Nothing to do.
                Log.v(LOG_TAG, "Our input string was null.");
                return;
            }
            Log.v(LOG_TAG, "Our input string was not null.");
            ...
            if (buffer.length() == 0) {
                ...
                Log.v(LOG_TAG, "Buffer was empty, no point in parsing");
                return;
            }
            Log.v(LOG_TAG, "buffer was not empty!");
        ...
        try {
            if (JSON_data != null) {
                ...
                Log.v(LOG_TAG, "we found "+String.valueOf(matches.length())+" matches");
                if (matches.length() == 0) {
