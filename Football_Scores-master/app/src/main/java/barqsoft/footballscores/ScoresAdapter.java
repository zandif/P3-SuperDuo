...
public class ScoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.date.setContentDescription("Game Time: " + cursor.getString(COL_MATCHTIME));

        mHolder.score.setText(Utilies.getScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt(COL_AWAY_GOALS)));
        mHolder.score.setContentDescription("Score: " + cursor.getInt(COL_AWAY_GOALS) + " to " + cursor.getInt(COL_HOME_GOALS));
        Log.i(LOG_TAG, "Game Time: " + cursor.getString(COL_DATE) + " " + cursor.getString(COL_MATCHTIME)
